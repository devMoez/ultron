...
const TIPS = [
  ...
  "Create {highlight}ultron.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "Place TUI settings in {highlight}~/.config/ultron/tui.json{/highlight} for global config",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "Ultron auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Ultron auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Ultron uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Ultron from reading sensitive files",
  "Use {highlight}ultron run{/highlight} for non-interactive scripting",
  "Use {highlight}ultron --continue{/highlight} to resume the last session",
  "Use {highlight}ultron run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}ultron serve{/highlight} for headless API access to Ultron",
  "Use {highlight}ultron run --attach{/highlight} to connect to a running server",
  "Run {highlight}ultron upgrade{/highlight} to update to the latest version",
  "Run {highlight}ultron auth list{/highlight} to see all configured providers",
  "Run {highlight}ultron agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}ultron github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}ultron debug config{/highlight} to troubleshoot configuration",
